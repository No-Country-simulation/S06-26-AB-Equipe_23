// components/charts/dashboardexecutivo.tsx
...
export default function DashboardExecutivo() {
  ...
  useEffect(() => {
    executarMatch()
      .then(setMatch)
      .catch(() => setError('Não foi possível carregar os candidatos. Tente novamente mais tarde.'));
  }, []);
  ...
  if (!match) return <div style={{ padding: 24 }}>Carregando dashboard...</div>;
