...
class MatchingJavaPythonParityExportTest {
    ...
    void exportJavaReferenceForPythonParity() throws IOException {
        ...
        List<CandidatoMatchDTO> sourceCandidates = List.of(
                new CandidatoMatchDTO("cand_001", "Candidato 1", "Analista", "junior", "Florianopolis", "cluster1", "88000", new BigDecimal("-27.5969"), new BigDecimal("-48.5494"), "remoto", List.of("sql", "python"), 3, "badge1", 91),
                new CandidatoMatchDTO("cand_002", "Candidato 2", "Analista", "pleno", "Sao Paulo", "cluster2", "01000", new BigDecimal("-23.5505"), new BigDecimal("-46.6333"), "presencial", List.of("java", "python"), 5, "badge2", 86)
        );
